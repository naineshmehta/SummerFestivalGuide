...
(function ($, window, document, undefined) {
    ...
    DynamicTreeView.prototype = {
        ...
        show: function() {
            this._getItems(this._selectedNodeId);
        },
        ...
        _onNodeIconClick: function (eventObject) {
            ...
            if ($clickedElement.hasClass(this.options.collapsedCss)) {
                ...
                this.controller.getChildren(nodeContext.data.id, this._sortOrder, onLoadChildNodesHandler);
        ...
        _getItems: function (selectedItemId) {
            this._loading(true);
            ...
            if (searchText) {
                ...
                this._$searchContainer.removeClass(this.options.searchOnCss);
                this.controller.getFirstLevelItems(this._sortOrder, this._onItemsLoadedHandler);
                this._searchHasBeenApplied = false;
            }
        },
    ...
    DynamicTreeViewController.prototype = {
        ...
        getTreeWithItem: function (itemId, sortOrder, onGetTreeCallback) {
            ...
            this._callGet({ itemId: itemId, sortOrder: sortOrder }, onGetTreeHandler, this.options.getTreeForItemMethod);
        },
        ...
        getChildren: function (parentId, sortOrder, onGetChildrenCallback) {
            var onGetChildrenHandler = $.proxy(this._onGetChildren, this, onGetChildrenCallback);
            this._callGet({ parentId: parentId, sortOrder: sortOrder }, onGetChildrenHandler, this.options.getChildrenMethod);
        },
        ...
        search: function(searchText, sortOrder, onSearchCallback) {
            var onSearchHandler = $.proxy(this._onSearch, this, onSearchCallback);
            this._callGet({ searchText: searchText, sortOrder: sortOrder }, onSearchHandler, this.options.searchMethod);
        },

        _onSearch: function (onSearchCallback, data, textStatus, jqXhr) {
            var rootNode = new dnn.NTree();
            rootNode.data = { hasChildren: true, name: "", id: this.options.rootId };
            rootNode.children = TreeNodeConverter.createNodesFromData(data.Items);
            onSearchCallback.apply(this, [rootNode]);
        },

        getFirstLevelItems: function (sortOrder, onGetFirstLevelItemsCallback) {
            var onGetFirstLevelItemsHandler = $.proxy(this._onGetFirstLevelItems, this, onGetFirstLevelItemsCallback);
            this._callGet({ sortOrder: sortOrder }, onGetFirstLevelItemsHandler, this.options.getFirstLevelItemsMethod);
        },

        _onGetFirstLevelItems: function (onListCallback, data, textStatus, jqXhr) {
            var root = new dnn.NTree();
            root.data = { hasChildren: true, name: "", id: this.options.rootId };
            root.children = TreeNodeConverter.createNodesFromData(data.Items);
            onListCallback.apply(this, [root]);
        }
    ...
    DynamicTreeViewController._defaults = {
        ...
        getFirstLevelItemsMethod: "PickListService/GetPages",
        searchMethod: "PickListService/SearchPages",
        getChildrenMethod: "PickListService/GetPages",
        getTreeForItemMethod: "PickListService/getTreePathForPage",
        rootId: "Root-11111"
    };
