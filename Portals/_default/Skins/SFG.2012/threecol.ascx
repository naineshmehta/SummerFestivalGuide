...
<div id="DNN6">
	...
	<div id="MenuBar">
	    <div id="SearchPanel">
	        <dnn:SEARCH ID="dnnSearch" runat="server" UseDropDownList="true" EnableTheming="true" SiteText="Search SFG" WebText="Search Google" SiteIconURL="~/Portals/_default/Skins/SFG.2012/images/sfg_search_icon.gif" Submit="<img src='/images/SearchButton.png' alt='Search' />" />
	    </div>
	    <div id="Nav">
	        <dnn:MENU ID="MENU2" MenuStyle="Mega2DNN" runat="server" Visible="true"></dnn:MENU>	        
	    </div>  
	</div>
    <div id="Content">
        <div id="Panes">
    ...
    <div id="Footer" class="footerback">
        <div id="FooterText">
            <ul>
                <li><asp:HyperLink NavigateUrl="~/Event_Calendar.aspx" Text="Event Calendar" runat="server"></asp:HyperLink>&nbsp;|</li>
                ...
                <li><asp:HyperLink NavigateUrl="~/Jobs_at_Summer_Festival_Guide.aspx" Text="Jobs / Vacancies" runat="server"></asp:HyperLink>&nbsp;|</li>                    
                <li><asp:HyperLink NavigateUrl="~/Festival_News.aspx" Text="Latest Festival News" runat="server"></asp:HyperLink></li>                    
            </ul>
            ...
            <div class="bot_pad">
                <div id="terms_style" class="footer">
                    ...
                    &nbsp;&nbsp;|&nbsp;&nbsp;<asp:HyperLink ID="HyperLink1" NavigateUrl="~/Cookies.aspx" Text="Cookie Info" runat="server" CssClass="footer"></asp:HyperLink>
                </div>
            </div>
