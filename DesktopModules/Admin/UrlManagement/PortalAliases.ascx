...
<asp:DataGrid ID="portalAiasesGrid" Runat="server" AutoGenerateColumns="false" width="100%" GridLines="None" CssClass="dnnGrid">
    ...
    <footerstyle />
	<Columns>
        <asp:TemplateColumn HeaderText="Primary" HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Center">
            <ItemTemplate>
                <asp:RadioButton runat="server" id="isPrimary" onclick="SelectOne(this, 'portalAiasesGrid')" 
        ...
        <asp:TemplateColumn HeaderText="Action" HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Center">
            ...
            <EditItemTemplate>
	            <dnn:DnnImageButton Runat="server" ID="saveButton" resourcekey="saveRule" OnCommand="SaveAiasesGrid" IconKey="Save" />
