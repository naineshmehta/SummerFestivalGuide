...
<asp:Panel ID="urlMaster_PortalSettings" runat="server" CssClass="portalSettingsCont">
    ...
    <div class="fieldOption">
        ...
        <span class="fieldValue">
            <asp:CheckBox ID="chkReplaceSpaces" runat="server" CssClass="Normal normalCheckBox"/><asp:TextBox ID="txtReplaceSpaceWith" runat="server" CssClass="Normal" Width="20px"/> 
    ...
    <div class="fieldOption">
        ...
        <span class="fieldValueWide">
            <asp:RadioButtonList ID="optPageExtensionUsage" runat="server" AutoPostBack="false" CssClass="Normal normalRadioButton" >
...
<div id="testUrls">
    ...
    <asp:UpdatePanel id="updPanelTestUrls" runat="server">
        ...
        <div class="fieldOption" id="testUrlGeneration">
            <span class="fieldValueWide">
