...
<div id="urlSettings" class="normal" style="text-align:left;">
    <input type="hidden" id="hdnModuleId" value="<%= ModuleId %>" />
<div>
...
<div id="tabs" class="dnnForm">
    ...
    <div id="advancedSettingsTab">
        <asp:Panel ID="urlMaster_AdvancedSettings" runat="server">
            ...
            <div class="fieldOption" >
                <span class="fieldLabel">
                    <dnn:Label ID="lblReplaceChars" runat="server"  EnableViewState="false" ResourceKey="ReplaceChars"/>
                </span>
                <span class="fieldValue">
                    <asp:TextBox ID="txtReplaceChars" runat="server" CssClass="Normal" width="80%" />
                    <ifty:PropertySource id="ctlReplaceChars" runat="server" CssClass="propertySourceCb"/>
                </span>
                <div class="fieldOptionFtr"></div>
            </div>     
    ...
    <asp:Panel ID="urlMaster_RegexSettings" runat="server">
        ...
        <div class="fieldOption">
	        <span class="fieldLabelWide">
                <dnn:Label ID="lblRegexMatch" runat="server" EnableViewState="false" ResourceKey="RegexMatch"/>
	        </span>
		    <span class="fieldValueWide">
	            <asp:TextBox ID="txtRegexMatch" runat="server" CssClass="regexTb"/>
                <ifty:PropertySource id="ctlRegexMatch" runat="server" />
		    </span>
		    <div class="fieldOptionFtr"></div>
	    </div> 
    </asp:Panel>
...
<div id="migrateDialog" class="migrateDialog umdialog" runat="server">
    <p><asp:Label runat="server" ID="lblMigrationTitle" CssClass="SubHead"></asp:Label></p>
    <asp:Label runat="server" ID="lblMigrateInfo" CssClass="Normal"></asp:Label>
    <asp:TextBox runat="server" ID="txtMigrateStatus" ReadOnly="true" TextMode="MultiLine" CssClass="migrateStatus" style="display;none"></asp:TextBox>
    <hr/>
    <asp:Button runat="server" ID="btnStartMigration" CssClass="Normal" UseSubmitBehavior="False" CausesValidation="False" OnClientClick="migrateToAUM(); return false;" />
</div>
    ...
    <div class="apply fieldOption">
        ...
        <asp:Button runat="server" id="btnMigrateToAUM" EnableViewState="false" OnClick="btnMigrateToAUM_Click" CssClass="Normal"  OnClientClick="return false;"/>
        <br />
