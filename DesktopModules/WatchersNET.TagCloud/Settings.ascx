...
<asp:panel id="pnlSettings" runat="server">
  ...
  <fieldset class="dnnClear">
      <div class="dnnFormItem">
          ...
          <dnn:DnnTextBox id="tbOccurCount" Width="50px" runat="server" CssClass="NumericTextBox" />
      </div>
      <div class="dnnFormItem">
    <dnn:label id="lblTagsCount" runat="server" ResourceKey="lblTagsCount" controlname="tbTags" suffix=":" CssClass="SubHead"></dnn:label>
      <dnn:DnnTextBox id="tbTags" Width="50px" runat="server" CssClass="NumericTextBox" />
     </div>
    <div class="dnnFormItem">
  ...
  <fieldset class="dnnClear">
   ...
   <div class="dnnFormItem">
        ...
        <dnn:DnnTextBox id="tbTspeed" runat="server" Width="50px" CssClass="NumericTextBox" />
      ...
      <td>
        <table id="tCustomTag" style="width:100%;" runat="server">
          <tr>
            ...
            <td style="vertical-align: top"><dnn:DnnTextBox id="tbCustomTag" runat="server" Width="194px" /></td>
          </tr>
          <tr>
    ...
    <asp:PlaceHolder id="phTax" runat="server" Visible="False">
        ...
        <h2 id="ReferralsOptionsPanel" class="dnnFormSectionHead"><a href="#"><asp:Label runat="server" id="ReferralsOptionsPanelLink" resourcekey="lTagSrcReferrals"></asp:Label></a></h2>
        <fieldset class="dnnClear">
           <div class="dnnFormItem">
