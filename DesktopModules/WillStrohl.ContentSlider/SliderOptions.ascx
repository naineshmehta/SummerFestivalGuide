...
<div id="dnnEditEntry" class="dnnForm dnnEditEntry dnnClear">
    ...
    <fieldset id="fsCommonSettings">
        <div class="dnnFormItem">
            ...
            <asp:TextBox ID="txtWidth" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
            <dnn:Label ID="lblHeight" runat="server" ResourceKey="lblHeight" ControlName="txtHeight" Suffix=":" />
            <asp:TextBox ID="txtHeight" runat="server" CssClass="NormalTextbox dnnFormRequired" Text="auto" ValidationGroup="slider" />
        ...
        <div class="dnnFormItem">
            ...
            <asp:TextBox ID="txtSpeed" runat="server" CssClass="NormalTextbox dnnFormRequired" Text="1000" ValidationGroup="slider" />
        ...
        <div class="dnnFormItem">
            ...
            <asp:TextBox ID="txtCacheDuration" runat="server" CssClass="NormalTextbox dnnFormRequired" Text="5" ValidationGroup="slider" />
    ...
    <fieldset id="fsAppearance">
        <div class="dnnFormItem">
            ...
            <asp:TextBox ID="txtCssAfter" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
            <dnn:Label ID="lblCssBefore" runat="server" ResourceKey="lblCssBefore" ControlName="txtCssBefore" Suffix=":" />
            <asp:TextBox ID="txtCssBefore" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
            <dnn:Label ID="lblEasing" runat="server" ResourceKey="lblEasing" ControlName="txtEasing" Suffix=":" />
            <asp:TextBox ID="txtEasing" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
            <dnn:Label ID="lblEaseIn" runat="server" ResourceKey="lblEaseIn" ControlName="txtEaseIn" Suffix=":" />
            <asp:TextBox ID="txtEaseIn" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
            <dnn:Label ID="lblEaseOut" runat="server" ResourceKey="lblEaseOut" ControlName="txtEaseOut" Suffix=":" />
            <asp:TextBox ID="txtEaseOut" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
    </fieldset>
    ...
    <fieldset id="fsPager">
        ...
        <div class="dnnFormItem">
            ...
            <asp:TextBox ID="txtActivePagerClass" runat="server" CssClass="NormalTextbox dnnFormRequired" Text="activeSlide" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
            ...
            <asp:TextBox ID="txtPagerAnchorBuilder" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />&nbsp; <asp:LinkButton ID="lnkDefaultPagerAnchorBuilder" runat="server" />
        </div>
        <div class="dnnFormItem">
            <dnn:Label ID="lblNext" runat="server" ResourceKey="lblNext" ControlName="txtNext" Suffix=":" />
            <asp:TextBox ID="txtNext" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
            <dnn:Label ID="lblPrev" runat="server" ResourceKey="lblPrev" ControlName="txtPrev" Suffix=":" />
            <asp:TextBox ID="txtPrev" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
    ...
    <fieldset id="fsBehavior">
        ...
        <div class="dnnFormItem">
            ...
            <asp:TextBox ID="txtAutoStopCount" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
        ...
        <div class="dnnFormItem">
            ...
            <asp:TextBox ID="txtMetaAttr" runat="server" CssClass="NormalTextbox dnnFormRequired" Text="cycle" ValidationGroup="slider" /> 
        ...
        <div class="dnnFormItem">
            ...
            <asp:TextBox ID="txtRequeueTimeout" runat="server" CssClass="NormalTextbox dnnFormRequired" Text="250" ValidationGroup="slider" /> 
        ...
        <div class="dnnFormItem">
            ...
            <asp:TextBox ID="txtShuffle" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
        ...
        <div class="dnnFormItem">
            ...
            <asp:TextBox ID="txtStartingSlide" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
    </fieldset>
    ...
    <fieldset id="fsTransition">
        <div class="dnnFormItem">
            ...
            <asp:TextBox ID="txtAnimIn" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
            <dnn:Label ID="lblAnimOut" runat="server" ResourceKey="lblAnimOut" ControlName="txtAnimOut" Suffix=":" />
            <asp:TextBox ID="txtAnimOut" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
        ...
        <div class="dnnFormItem">
            ...
            <asp:TextBox ID="txtDelay" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
            <dnn:Label ID="lblFastOnEvent" runat="server" ResourceKey="lblFastOnEvent" ControlName="txtFastOnEvent" Suffix=":" />
            <asp:TextBox ID="txtFastOnEvent" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
            <dnn:Label ID="lblFx" runat="server" ResourceKey="lblFx" ControlName="cboFx" Suffix=":" />
            <asp:DropDownList ID="cboFx" runat="server" CssClass="NormalTextbox dnnFormRequired" ValidationGroup="slider" />
        ...
        <div class="dnnFormItem">
            ...
            <asp:TextBox ID="txtSpeedIn" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
            <dnn:Label ID="lblSpeedOut" runat="server" ResourceKey="lblSpeedOut" ControlName="txtSpeedOut" Suffix=":" />
            <asp:TextBox ID="txtSpeedOut" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
            <dnn:Label ID="lblTimeout" runat="server" ResourceKey="lblTimeout" ControlName="txtTimeout" Suffix=":" />
            <asp:TextBox ID="txtTimeout" runat="server" CssClass="NormalTextbox dnnFormRequired" ValidationGroup="slider" />
    ...
    <fieldset id="fsJavaScriptEvents">
        <div class="dnnFormItem">
            ...
            <asp:TextBox ID="txtAfter" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
            <dnn:Label ID="lblBefore" runat="server" ResourceKey="lblBefore" ControlName="txtBefore" Suffix=":" />
            <asp:TextBox ID="txtBefore" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
            <dnn:Label ID="lblEnd" runat="server" ResourceKey="lblEnd" ControlName="txtEnd" Suffix=":" />
            <asp:TextBox ID="txtEnd" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
            <dnn:Label ID="lblFxFn" runat="server" ResourceKey="lblFxFn" ControlName="txtFxFn" Suffix=":" />
            <asp:TextBox ID="txtFxFn" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
            <dnn:Label ID="lblOnPagerEvent" runat="server" ResourceKey="lblOnPagerEvent" ControlName="txtOnPagerEvent" Suffix=":" />
            <asp:TextBox ID="txtOnPagerEvent" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
            <dnn:Label ID="lblOnPrevNextEvent" runat="server" ResourceKey="lblOnPrevNextEvent" ControlName="txtOnPrevNextEvent" Suffix=":" />
            <asp:TextBox ID="txtOnPrevNextEvent" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
            <dnn:Label ID="lblPagerEvent" runat="server" ResourceKey="lblPagerEvent" ControlName="txtPagerEvent" Suffix=":" />
            <asp:TextBox ID="txtPagerEvent" runat="server" CssClass="NormalTextbox dnnFormRequired" Text="click.cycle" ValidationGroup="slider" />
        ...
        <div class="dnnFormItem">
            ...
            <asp:TextBox ID="txtPrevNextEvent" runat="server" CssClass="NormalTextbox dnnFormRequired" Text="click.cycle" ValidationGroup="slider" />
        ...
        <div class="dnnFormItem">
            ...
            <asp:TextBox ID="txtSlideExpr" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
            <dnn:Label ID="lblTimeoutFn" runat="server" ResourceKey="lblTimeoutFn" ControlName="txtTimeoutFn" Suffix=":" />
            <asp:TextBox ID="txtTimeoutFn" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
        <div class="dnnFormItem">
            ...
            <asp:TextBox ID="txtUpdateActivePagerLink" runat="server" CssClass="NormalTextbox" ValidationGroup="slider" />
        </div>
    </fieldset>
</div>
<div class="dnnClear">
