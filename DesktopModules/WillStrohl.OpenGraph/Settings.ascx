...
<div id="dnnOpenGraphSettings" class="dnnForm dnnEditEntry dnnClear">
    <h2 id="dnnPanel-h2OpenGraph" class="dnnFormSectionHead"><%= Localization.GetString("OpenGraphSettings.Text", Me.LocalResourceFile)%></h2>
    <fieldset id="fsOpenGraphSettings">
        <div class="dnnFormItem">
            <div class="dnnFormMessage dnnFormInfo"><%= Me.GetLocalizedString("SettingsOverview.Text") %></div>
        </div>
        <div class="dnnFormItem">
        ...
        <div class="dnnFormItem">
            <dnn:Label ID="lblOverrideOpenGraph" runat="server" ResourceKey="lblOverrideOpenGraph" ControlName="chkOverrideOpenGraph" Suffix=":" />
            <asp:CheckBox runat="server" ID="chkOverrideOpenGraph" ValidationGroup="OpenGraph" />
        </div>
        <div class="dnnFormItem">
